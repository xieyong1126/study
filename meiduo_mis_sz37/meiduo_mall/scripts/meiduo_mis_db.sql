...
CREATE TABLE `tb_addresses` (
  ...
  KEY `tb_addresses_user_id_dc7b4119_fk_tb_users_id` (`user_id`),
  ...
  CONSTRAINT `tb_addresses_user_id_dc7b4119_fk_tb_users_id` FOREIGN KEY (`user_id`) REFERENCES `tb_users` (`id`)
...
CREATE TABLE `tb_users` (
  ...
  KEY `tb_users_default_address_id_20d9143e_fk_tb_addresses_id` (`default_address_id`),
  CONSTRAINT `tb_users_default_address_id_20d9143e_fk_tb_addresses_id` FOREIGN KEY (`default_address_id`) REFERENCES `tb_addresses` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_users` VALUES (1, 'pbkdf2_sha256$36000$HuLBT1utlRQ5$BFF374bxQgKZS+BNBVJF9vA9g7RPFU/g39a09ih3cPM=', '2019-04-06 14:26:15.116329', 0, 'python', '', '', '3442367443@qq.com', 0, 1, '2019-04-06 12:23:39.443198', '13711111111', 1, 1);
INSERT INTO `tb_users` VALUES (2, 'pbkdf2_sha256$36000$1v025zawxbVF$b818JWGp6XmMU9NLIKt0FPKY2TDJLzTfjp+Sm/MwBGw=', NULL, 1, 'admin', '', '', '1@1.com', 1, 1, '2019-04-11 05:16:21.875675', '', 0, NULL);
INSERT INTO `tb_users` VALUES (3, 'pbkdf2_sha256$36000$UauPboRlywdz$HcoaInzks+4EdcdjZWmJqSy5lvT6SFgSjWWEsgIL3ts=', NULL, 0, 'itcast', '', '', '', 0, 1, '2019-04-11 06:26:31.004717', '13611111111', 0, NULL);
COMMIT;
...
CREATE TABLE `tb_users_groups` (
  ...
  `group_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_users_groups_user_id_group_id_b88eab82_uniq` (`user_id`,`group_id`),
  KEY `tb_users_groups_group_id_9afc8d0e_fk_auth_group_id` (`group_id`),
  CONSTRAINT `tb_users_groups_group_id_9afc8d0e_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`),
  CONSTRAINT `tb_users_groups_user_id_5f6f5a90_fk_tb_users_id` FOREIGN KEY (`user_id`) REFERENCES `tb_users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_users_user_permissions` (
  ...
  `permission_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_users_user_permissions_user_id_permission_id_43338c45_uniq` (`user_id`,`permission_id`),
  KEY `tb_users_user_perm_permission_id_0b93982e_fk_auth_perm` (`permission_id`),
  CONSTRAINT `tb_users_user_perm_permission_id_0b93982e_fk_auth_perm` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`),
  CONSTRAINT `tb_users_user_permissions_user_id_20aca447_fk_tb_users_id` FOREIGN KEY (`user_id`) REFERENCES `tb_users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
